...
int namedpipe;
int max_size = 20;
char message[max_size+1]; /* Message to be written to pipe */
char buffer[max_size+1]; /* Data to be read from pipe */
bool paramerror= false;
/* Check for existence of named pipe and create it if itb doesn’t exist */
...
sprintf(message, "%d", i);
/* Instead of printing to the standard output, sprintf stores
the formatted string in the character array ‘message’ */
strcat(message, " message text"); /* add more to string */
